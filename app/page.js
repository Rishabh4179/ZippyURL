      ...
      <section className="grid grid-cols-2 h-[50vh]">
        <div className="flex flex-col gap-4 items-center justify-center">
          ...
          <p className="px-36 text-center">
            We are the best starightforward URL Shortner in the world. Most of the url shorteners will track you or ask you to give your details for login. We understand your needs and hence we have created this URL shortener
          </p>
        ...
        <div className="flex justify-start relative">
          <Image className="mix-blend-darken" alt="an image of a vector" src={"/ZippyURL.jpg"}  fill={true}/>
        </div>
      </section>
    </main>
  );
